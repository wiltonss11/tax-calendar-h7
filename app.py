...
def get_states():
    ...
    try:
        conn = get_db_connection()
        if not conn:
            raise RuntimeError('Sem conexão com MySQL')
        ...
        # Fallback estático para garantir que o combo de estados apareça
        static_codes = [
        ...
        fallback = [{'code': c, 'name': state_names[c]} for c in static_codes]
